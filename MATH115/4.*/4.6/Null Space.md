...
- Note: It follows from above that $Dim(Null(A)) = n-Rank(A)$. This is called $nullity(A)$, and is the rank of the basis of Null(A) (This is derived from [[Ranks of Matrices and System Rank Theorem|SRT(2)]])
