...
- Note: The basis set B of subspace U can be thought of in two ways:
	- A minimal spanning set of U, such that if you remove any element of B, then B will no longer span U. This is because B is linearly independant. See [[Archive/MATH115/4/4.3/Linear Dependence and Independence|the dependency theorem and reduction theorem]]
	- A maximal spanning set of U, such that if you add any element of U to B, then B will become linearly dependant. This is because since the span of U is B, any new vector that isn't already in B will be a linear combination of B by [[Archive/MATH115/4/4.3/Linear Dependence and Independence|Dependency Theorem]].
