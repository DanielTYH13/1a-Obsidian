...
- Given the matrix $A \in M_{nxn}(\mathbb{R})$, then we have by definition of [[Archive/MATH115/8/8.1/Eigenvalues and Eigenvectors]], 
...
- Some requirements:
	...
	- Thus, we also have by [[Archive/MATH115/3/3.5/Matrix Invertibility Criteria]] that for there to be nontrivial solutions to this system, $det(A-\lambda I) = 0$, ie it is not invertible
